...
public class Example03Complex {
    ...
    private Example03Complex(Builder builder) {
...
//    public Example03Complex(final int param1, final String param2, final boolean param3, final Object param4,
//                            final int param5) {
//        this.param1 = param1;
//        this.param2 = param2;
//        this.param3 = param3;
...
//    }
    ...
    public static final class Builder {
        ...
        public Example03Complex build() {
            return new Example03Complex(this);
        }
    }
}
